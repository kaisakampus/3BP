...
# load timestep sizes
timesteps_main = np.loadtxt(r"C:\Users\kaisa\My Drive\Simulated_Data\panio_trio_O50_04_LAST_timestep_sizes.csv")
timesteps_sub  = np.loadtxt(r"C:\Users\kaisa\My Drive\Simulated_Data\panio_trio_O50_04_add_LAST_timestep_sizes.csv")
timesteps_add  = np.loadtxt(r"C:\Users\kaisa\My Drive\Simulated_Data\panio_trio_O50_sub_LAST_timestep_sizes.csv")
...
plt.plot(cumulative_time_sub[1:],  timesteps_sub[1:],  color="turquoise", linewidth=1, label="O50 (r1_x-ε)")
plt.plot(cumulative_time_add[1:],  timesteps_add[1:],  color="lime",      linewidth=1, label="O50 (r1_x+ε)")
plt.plot(cumulative_time_main[1:], timesteps_main[1:], color="deeppink",  linewidth=1, label="O50 r1_x")  # last = on top
plt.xlim(left=0)
